...
def index2(request):
    r = requests.get('http://api.mediastack.com/v1/news?access_key=86487dbfd37aa1c7ee940cfb176b6e3e&languages=en&categories=health&keywords=covid&sort=published_desc&published_at&limit=1')
    res = r.json()
    data = res['data']
    icon = []
    title = []
